...
class Test_Allure_report:
    def test_amazone_web(self):
        ...
        # self.driver = webdriver.chrome(executable_path='C:\\Users\\MOHIT\\PycharmProjects\\SELENIUM\\Drivers\\chromedriver.exe')
        # chrome_service = Service(executable_path="/home/user/.local/bin/chromedriver")
