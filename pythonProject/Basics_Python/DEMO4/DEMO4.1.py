...
class Employee:
    ...
    def calculate_employee_wage_pr_day(self, number):
        """
        here we are using dictionary and with the help of keys we are checking the employee is present or absent
        :param number:
        :return:
        """
        try:
    ...
    def calculating_wage_per_mnth(self):
        """
        here we are using while loop to calcilate the employee wage per month
        :return:
        """
        try:
            daily_wage_dict = {}
...
if __name__ == "__main__":
    """
    Here we created class Employee object with the help of that object we are calling require method
    """
    emp1 = Employee()
